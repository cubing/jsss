...
NPM_COMMANDS = build build-esm build-esm-browser build-esm-browser-bundle-global build-cjs build-types vendor-cubing test-node test-node-require test-node-import test-node-browser-bundle-global dev clean prepack
