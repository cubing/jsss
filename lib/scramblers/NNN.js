...
module.exports['222'] = generate_NNN_scrambler(2, 20, true);
module.exports['333'] = generate_NNN_scrambler(3, 30, true);
module.exports['444'] = generate_NNN_scrambler(4, 40, true);
module.exports['555'] = generate_NNN_scrambler(5, 60, true);
module.exports['666'] = generate_NNN_scrambler(6, 70, true);
module.exports['777'] = generate_NNN_scrambler(7, 100, true);