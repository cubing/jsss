export function relativeWorkerPath() {
  return "./scrambles-worker.js";
}

export function esmAbsoluteURL() {
...
export function esmTrampoline() {
  const importSrc = `import "${esmAbsoluteURL()}";`;
