...
var MegaminxScramblingNotationMapper = class {
  ...
  notationToInternal(mv) {
    if (mv.innerLayer === void 0 && mv.outerLayer === void 0) {
      ...
      if (mv.family === "y") {
        return new BlockMove(void 0, void 0, "Uv", mv.amount);
      }
    }
...
var PuzzleGeometry = class {
  ...
  parseBlockMove(blockmove) {
    const bm = this.notationMapper.notationToInternal(blockmove);
    if (bm === null) {
...
//# sourceMappingURL=chunk.FIAL4PXX.js.map
