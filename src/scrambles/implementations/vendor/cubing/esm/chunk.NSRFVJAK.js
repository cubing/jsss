...
var Unit = class extends AlgPart {
};
var Move = class extends Unit {
};
var Annotation = class extends Unit {
};
var Container = class extends Unit {
};
var Sequence = class extends AlgPart {
...
var Commutator = class extends Container {
...
var Conjugate = class extends Container {
  constructor(A, B, amount = 1) {
    super();
    this.A = A;
    this.B = B;
...
var NewLine = class extends Annotation {
  constructor() {
    super();
    this.type = "newLine";
    Object.freeze(this);
...
var Comment = class extends Annotation {
  constructor(comment) {
    super();
...
var BlockMove = class extends Move {
...
var Invert = class extends TraversalUp {
...
var Expand = class extends TraversalUp {
  traverseSequence(sequence) {
...
var StructureEquals = class extends TraversalDownUp {
...
var CoalesceBaseMoves = class extends TraversalUp {
  traverseSequence(sequence) {
    const coalesced = [];
...
var ToString = class extends TraversalUp {
  traverseSequence(sequence) {
    let output = "";
...
var invertInstance = new Invert();
var expandInstance = new Expand();
var structureEqualsInstance = new StructureEquals();
var coalesceBaseMovesInstance = new CoalesceBaseMoves();
var algToStringInstance = new ToString();
var invert = invertInstance.traverseSequence.bind(invertInstance);
var expand = expandInstance.traverseSequence.bind(expandInstance);
var structureEquals = structureEqualsInstance.traverseSequence.bind(structureEqualsInstance);
var coalesceBaseMoves = coalesceBaseMovesInstance.traverseSequence.bind(coalesceBaseMovesInstance);
var algToString = algToStringInstance.traverseSequence.bind(algToStringInstance);
var algPartStructureEqualsForTesting = algToStringInstance.traverse.bind(algToStringInstance);
var algPartToStringForTesting = algToStringInstance.traverse.bind(algToStringInstance);
...
var ValidatorTraversal = class extends TraversalUp {
};
...
var BaseMoveValidator = class extends ValidatorTraversal {
  traverseSequence(sequence) {
...
var BlockMoveValidator = class extends BaseMoveValidator {
  traverseBlockMove(blockMove) {
    if (typeof blockMove.outerLayer !== "undefined") {
      if (typeof blockMove.innerLayer === "undefined") {
...
var FlatAlgValidator = class extends ValidatorTraversal {
  traverseSequence(sequence) {
    for (const unit of sequence.nestedUnits) {
      this.traverse(unit);
    }
...
var BlockMoveValidatorInstance = new BlockMoveValidator();
var validateSiGNMoves = BlockMoveValidatorInstance.traverse.bind(BlockMoveValidatorInstance);
var flatAlgValidatorInstance = new FlatAlgValidator();
var validateFlatAlg = flatAlgValidatorInstance.traverse.bind(flatAlgValidatorInstance);

// src/cubing/alg/parser/parser-shim.js
...
//# sourceMappingURL=chunk.AH5MI32N.js.map
